      ...
      <section class="text-gray-400 bg-gray-900 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              class="lg:w-1/2 w-full lg:h-auto max-h-[600px] object-contain h-64  object-center rounded mt-10"
              src={product?.image}
            />
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 class="text-white text-3xl title-font font-medium mb-1 uppercase">
                {product?.category}
              </h1>
              <div class="flex mb-4">
              ...
              <div class="flex  items-center border h-[100px]  justify-between gap-[25px]">
                <span class="title-font font-medium text-2xl text-white">
                  ${product?.price}
                </span>
                <button
                  class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-[22px]"
